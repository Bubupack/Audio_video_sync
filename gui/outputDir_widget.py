...
class OutputDirWidget(QWidget):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.curent_directory = DEFAULT_OUTPUT_DIR
        self.init_ui()
    ...
    def init_ui(self) -> None:
        ...
        self.directory_label = QLabel(f"Current directory: {self.curent_directory}")
    ...
    def _open_file_dialog(self) -> None:
        ...
        if dir_name:
            self.curent_directory = dir_name
            self.directory_label.setText(f"Current directory: {self.curent_directory}")
            self.output_directory.emit(dir_name)