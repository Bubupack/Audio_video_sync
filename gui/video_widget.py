...
Audio is intentionally disabled — the widget is used for visual
preview only, not for audio playback.
"""
...
class VideoWidget(BaseMediaPlayerWidget):
    ...
    video_loaded = BaseMediaPlayerWidget.media_loaded  # semantic alias
    ...
    def _configure_player(self) -> None:
        ...
        # Attach a muted audio output so the video is guaranteed to stay
        # silent (per project requirement).
